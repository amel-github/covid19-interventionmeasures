...
for(i in 1:length(countries_with_measures)) {
  ...
  date_cases <- JH_data_one_country$date[JH_data_one_country$cases>=200]
...
name <- "Measures_Countries_time_of_activation_zeroday200cases.png"
ggsave(plot,  file = name,  width = 33*1.25, height = 27 *1.25, units = "cm", dpi=96) 
name <- "Measures_Countries_time_of_activation_zeroday200cases.svg"
ggsave(plot,  file = name,  width = 33*1.25, height = 27 *1.25, units = "cm", dpi=96) 
